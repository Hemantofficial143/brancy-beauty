<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ setActiveClass('dashboard.index') }}">
            <a href="{{ adminRoute('dashboard.index') }} " class="menu-link">
        ...
        <li class="menu-item {{ setActiveClass('users.index') }}">
            <a href="{{adminRoute('users.index')}}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-user"></i>
                <div data-i18n="Users">Users</div>
            </a>
        </li>
        <li class="menu-item {{setActiveClass('inquiries.index')}}">
            <a href="{{adminRoute('inquiries.index')}}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-notes"></i>
                <div data-i18n="Inquiries">Inquiries</div>
            </a>
        </li>

        <li class="menu-item {{setActiveClass('subscribers.index')}}">
            <a href="{{ adminRoute('subscribers.index') }}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-rss"></i>
                <div data-i18n="Subscribers">Subscribers</div>
            </a>
        </li>
        <li class="menu-item {{ setActiveClass('blogs.index') }}">
            <a href="{{ adminRoute('blogs.index') }}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-brand-codesandbox"></i>
                <div data-i18n="Blogs">Blogs</div>
            </a>
        </li>
        <li class="menu-item {{ setActiveClass('promo-codes.index') }}">
            <a href="{{ adminRoute('promo-codes.index') }}" class="menu-link">

                    ...
                    <div class="d-flex align-items-end row">
                        ...
                        <div class="col-5 text-center text-sm-left">
                            <div class="card-body pb-0 px-0 px-md-4">
                                <img
                                    src="/adassets/img/illustrations/card-advance-sale.png"
                                    height="140"
                                    alt="view sales"/>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-0">
                        <div class="row row-bordered g-0">
                            ...
                            <div class="col-md-4 p-4">
                                ...
                                <p class="mb-4 text-center"><span class="fw-medium">Budget: </span>56,800
                                </p>
                                <div class="px-3">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 pb-1">
                                <div class="me-3">
                                    <img src="/adassets/img/products/iphone.png" alt="User" class="rounded"
                                         width="46"/>
                                </div>
                                <div
                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="me-3">
                                    <img
                                        src="/adassets/img/products/nike-air-jordan.png"
                                        alt="User"
                                        class="rounded"
                                        width="46"/>
                                </div>
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="me-3">
                                    <img src="/adassets/img/products/headphones.png" alt="User"
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="me-3">
                                    <img
                                        src="/adassets/img/products/apple-watch.png"
                                        alt="User"
                                        class="rounded"
                                        width="46"/>
                                </div>
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="me-3">
                                    <img
                                        src="/adassets/img/products/amazon-echo.png"
                                        alt="User"
                                        class="rounded"
                                        width="46"/>
                                </div>
                            ...
                            <li class="d-flex">
                                <div class="me-3">
                                    <img
                                        src="/adassets/img/products/play-station.png"
                                        alt="User"
                                        class="rounded"
                                        width="46"/>
                                </div>
